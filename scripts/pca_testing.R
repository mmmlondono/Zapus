...
test <- read.vcfR("vcf/pop5.75.filtered.vcf")
test <- read.vcfR("vcf/pop8.75.filtered.vcf")
#with a .95 completeness 
test <- read.vcfR("vcf/pop5R95.snps.vcf")
test <- read.vcfR("vcf/pop8R95.snps.vcf")
...
popmap<-read.csv("popmaps/popmap5.75.csv")
popmap<-read.csv("popmaps/popmap8.75.csv")
#with a .95 completeness not filtered
...
#popmap
pop(focal_gl) <- c("NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NE", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "NW", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "rio", "sac", "sac", "sac", "sac", "sac", "sac", "sac", "sac", "sac", "sac", "sac", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht", "wht")
